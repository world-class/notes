...
image::./assets/degree_vertex.png[align=center, width=450]
...
image::./assets/degree_in_out_vertex.png[align=center, width=450]
...
image::./assets/degree_sequence.png[align=center, width=500]
