...
image::./assets/simple_graphs.png[align=center, width=500]
...
image::./assets/regular_graphs.png[align=center, width=550]
...
image::./assets/regular_graphs_example.png[align=center, width=350]

=== Special Regular Graphs: Cycles

image::./assets/graph_regular_cycles.png[align=center, width=350]
...
image::./assets/graph_complete.png[align=center, width=450]
...
image::./assets/graph_complete_example.png[align=center, width=350]
